...
for pop in pop_list:
 ...
 #   print "hello"
	...
	if (num_samples == 8):
	    t = './maxfiles/'+str(num_samples)+'/eight.' + str(k_total) +'.'+pop + '.max'
	elif (num_samples == 2 or num_samples == 3):
	    t = './maxfiles/'+str(num_samples)+'/pair.' + str(k_total) +'.'+pop + '.max'
	else:
	    t = './maxfiles/'+str(num_samples)+'/'+str(num_samples)+'.' + str(k_total) +'.'+pop + '.max'
	#print t
    	try:
            max_file = open(t, "r")
...
#for pop1 in pop_list:
    #k_pop = 0 #k_pop is reset for each new population
    #s1 = pop1 + '.samples'
    #try:
        #input_file1 = open(s1, "r")
  ##      print "input file is", input_file1.name
    #except IOError:
    	#print "Oh no, we couldn't open our file!"
    
 ##   print "hello"
    #for k1 in range(1, len_dict[pop1]+1):
        #sam1 = line1.strip()
	#j = 0
        #for pop2 in pop_list:
       	    #s2 = pop2 + '.samples'
    	    #try:
	        #input_file2 = open(s2, "r")
  ##     	 print "input file is", input_file2.name
    	    #except IOError:
    		#print "Oh no, we couldn't open our file!"
    
 ##   print "hello"
 	    #for k2 in range(1, len_dict[pop2]+1):	
		##print 'hi there'
		#sam2 = line2.strip()
		##print sam1, sam2, pop1, pop2
		##print deciles_dict['sam1']
...
#plt.xticks(midpoint_list, pop_list)
#plt.yticks(midpoint_list, pop_list)
#plt.title(' L2 distance between deciles of length dist, 4 haps = 2 ind' )
#plt.show()
